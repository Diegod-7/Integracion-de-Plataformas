...
describe('🔐 AUTENTICACIÓN - CASOS DE PRUEBA EXPANDIDOS', () => {
  ...
  describe('📝 REGISTRO DE USUARIO - VALIDACIONES AVANZADAS', () => {
    ...
    test('❌ Debe fallar con email muy largo', async () => {
    ...
    test('❌ Debe fallar con contraseña muy larga', async () => {
      const longPassword = 'a'.repeat(1000);
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 'Test User',
          email: 'testlongpass@test.com',
    ...
    test('❌ Debe fallar con email con múltiples @', async () => {
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 'Test User',
    ...
    test('❌ Debe fallar con email con caracteres Unicode maliciosos', async () => {
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 'Test User',
    ...
    test('❌ Debe fallar con nombre con caracteres de control', async () => {
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 'Test\u0001User',
          email: 'testcontrol@test.com',
          password: '123456'
        });
    ...
    test('❌ Debe fallar con tipos de datos incorrectos', async () => {
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 123,
    ...
    test('❌ Debe fallar con payload muy grande', async () => {
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 'Test User',
          email: 'testbig@test.com',
          password: '123456',
    ...
    test('❌ Debe fallar con email que contenga emojis', async () => {
      const response = await request(appTest)
        .post('/api/auth/register')
        .send({
          name: 'Test User',
