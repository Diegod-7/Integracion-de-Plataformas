...
describe('📦 PRODUCTOS - CASOS DE PRUEBA EXPANDIDOS', () => {
  ...
  describe('➕ CREAR PRODUCTO - VALIDACIONES AVANZADAS', () => {
    ...
    test('❌ Debe fallar con caracteres especiales maliciosos', async () => {
      const response = await request(appPrueba)
        .post('/api/products')
        .send({
    ...
    test('❌ Debe fallar con inyección SQL en nombre', async () => {
      const response = await request(appPrueba)
        .post('/api/products')
        .send({
    ...
    test('❌ Debe fallar con descripción muy larga', async () => {
      const response = await request(appPrueba)
        .post('/api/products')
        .send({
